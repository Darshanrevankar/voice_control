...
#     song_selection = st.radio("Select Song", mp3_files, index=current_song_index)
...
#     # album_art_image = song_to_album_art.get(current_song, "dance-music.gif")
...
#     if st.button("⏭️ Next") and current_song_index < len(mp3_files) - 1:
#         current_song_index += 1
